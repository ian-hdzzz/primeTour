...
int main(){
    CVideo *video[4];
    video[0] = new CVideo("#01", "You Shook Me All Night", "3min 10s", "Rock", " AC/DC", 4 );
    video[1] = new CVideo("#02", "Living On A Prayer", "3min 40s", "Rock", "Bon Jovi", 5 );
    video[2] = new CVideo("#03", "Another One Bites The Dust", "2min 59s", "Rock", "Queen", 5);
    video[3] = new CVideo("#03", "Sabor a Chocolate", "3min 15s", "Rock", "Elefante", 4);

    

    cout << "\n-------------- STREAMING ROCK --------------" << endl;
    
    ofstream web("rock.html");
    
    web<< "<html><head> <title> Prime Tour </title> <link rel= \"stylesheet\" href=\"rock.css\"</head><body>" << endl;
    ...
    web << "<h3 class=\"titulo\"> ROCK </h3>" <<endl;
    string toursVivo [] = {"V9.png", "V10.png", "V11.png", "V12.png"};
        ...
        for(int i = 0;i<4 ;i++){
            ...
            web << "<div class=\"target\">" << endl;
                ...
                web << "<div class=\"cover\"> <h3 class=\"titulo\"> "<< video[i] -> artista << "</h3> <a href =\"../home/acdc.html\"><img src=\"" << cover << "\" alt =\"\"></a></div>"<< endl;
