#include "../clases/videosOficiales.cpp"
#include <sstream>
#include <fstream>
...
int main(){
    CVideo *video[4];
    video[0] = new CVideoOficial("#01", "24k magic - Vivo", "3 min 10s", "Pop", "Bruno Mars", 5, "Sencillo", "BBC Radio" );
    video[1] = new CVideoOficial("#02", "Memories - Acoustic", "2min 58s", "Pop", "Maroon 5", 4,"JORDI(deluxe)", "The Howard Stern Show" );
    video[2] = new CVideoOficial("#03", "Sign of the Times - Vivo", "3min 20s", "Pop", "Harry Styles", 5, "Harry Styles(deluxe)", "BBC Radio" );
    video[3] = new CVideoOficial("#04", "Nothing Else Matters - Oficial", "4 min 10s", "Rock", "Metallica", 4, "Metallica (deluxe)", "Video Oficial" );


    cout << "\n-------------- STREAMING MUSIC VIDEOS 3 --------------" << endl;
    
    ofstream web("videosOficiales.html");
    
    web<< "<html><head> <title> Prime Tour </title> <link rel= \"stylesheet\" href=\"videosOficiales.css\"</head><body>" << endl;
     ...
     web << "<nav class=\"menu\">" << endl;
            ...
            web << "<div class=\" categorias\">" << endl;
                ...
                web << "<div class=\"contenedor-categorias \">" << endl;
                    ...
                    web << "<a href=\"../videosOficiales/videosOficiales.html\" class=\"active\"> Videos Oficiales </a>" << endl;
    ...
    web << "<h3 class=\"titulo\"> Videos Oficiales </h3>" <<endl;
    string toursVivo [] = {"V5.png", "V6.png", "V7.png", "V8.png"};
        ...
        for(int i = 0;i<4 ;i++){
            ...
            web << "<div class=\"target\">" << endl;
                ...
                web << "<div class=\"cover\"> <h3 class=\"titulo\"> "<< video[i] -> artista << "</h3> <a href =\"../home/bruno.html\"><img src=\"" << cover << "\" alt =\"\"></a></div>"<< endl;
            
                // web << "<div class=\"reproducir\">    << video[i] -> reproducir() << "</div>"<< endl;
